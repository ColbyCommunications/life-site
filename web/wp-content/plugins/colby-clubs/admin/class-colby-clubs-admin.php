...
class Colby_Clubs_Admin {
	...
	public function enqueue_styles() {
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/colby-clubs-admin.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/colby-clubs-admin.js', array( 'jquery' ), $this->version, false );
	}
	...
	public function init_cpt() {
		// Register Custom Post Type
		$labels = array(
			'name'                  => _x( 'Clubs', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'Club', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'Clubs & Orgs', 'text_domain' ),
			'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
			'archives'              => __( 'Club Archives', 'text_domain' ),
			'attributes'            => __( 'Club Attributes', 'text_domain' ),
			...
			'view_items'            => __( 'View Clubs', 'text_domain' ),
		...
		$rewrite = array(
			'slug'                  => 'club_organization',
			'with_front'            => true,
			'pages'                 => true,
			'feeds'                 => true,
		);
		$args = array(
			'label'                 => __( 'Club', 'text_domain' ),
			'description'           => __( 'Club or Organization', 'text_domain' ),
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions' ),
			'taxonomies'            => array( 'cc_club_tax' ),
			'hierarchical'          => false,
			'public'                => true,
			'show_ui'               => true,
			'show_in_menu'          => true,
		...
		register_post_type( 'cc_club', $args );
	}
	...
	public function init_tax_category() {
		...
		register_taxonomy( 'cc_club_tax', array( 'cc_club' ), $args );
